...
**Current ticket:** T-12 (`in-progress` — Auto-cycle scheduler + crossfade (60 s / 2 s, adjustable) + native tests)
**Last completed:** T-11 (`done` — commit `d424447`)
...
| T-12 | Auto-cycle scheduler + crossfade (60 s / 2 s, adjustable) + native tests | 3h | — | in-progress | SPEC §Behaviour |
