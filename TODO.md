...
**Current ticket:** T-25 (`in-progress` — App BLE layer: scan by service UUID, bond (system PIN dialog), GATT client, remember owl + auto-reconnect; protocol codec + JVM tests)
**Last completed:** T-24 (`done` — commit `c25c839`)
...
| T-25 | App BLE layer: scan by service UUID, bond (system PIN dialog), GATT client, remember owl + auto-reconnect; protocol codec + JVM tests | 4h | T-22, T-24 | in-progress | |
