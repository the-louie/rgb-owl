...
**Current ticket:** T-07 (`in-progress` — Flame (per-column heat, Fire2012-style, grid-aware))
...
| T-07 | Flame (per-column heat, Fire2012-style, grid-aware) | 3h | — | in-progress | SPEC §Effects 3 |
