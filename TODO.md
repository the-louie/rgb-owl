...
**Current ticket:** T-15 (`in-progress` — WiFi: WiFiManager non-blocking portal `Owl-Setup`, STA, hostname + mDNS `owl.local`)
**Last completed:** T-14 (`done` — commit `6e13b03`)
...
| T-15 | WiFi: WiFiManager non-blocking portal `Owl-Setup`, STA, hostname + mDNS `owl.local` | 3h | — | in-progress | Backlog row 2 |
