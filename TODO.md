...
**Current ticket:** T-39 (`in-progress` — App pushes phone time + timezone on every connect)
...
| T-39 | App pushes phone time + timezone on every connect | 1h | T-34 | in-progress | |
