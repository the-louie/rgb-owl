...
constexpr uint32_t UPDATE_PERIOD_MS = 24UL * 3600 * 1000;  // update check interval after the boot check
constexpr uint32_t UPDATE_ONLINE_TIMEOUT_MS = 60000;      // give up an update check if WiFi is not up by then
